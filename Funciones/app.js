...
window.onload = () => {
  ...
  <div class="header-escritorio">
    <a title="Educar LAB" href="#top">
      <img class="header-logo" src="./logosConectar/logoMendozaFutura.jpg" alt="Logo de Conectar LAB" />
    </a>
  ...
  <img src="./logosConectar/logoMendozaFutura.png"  >
  <div class="contacto-info">
    <h1>¡Seguinos en nuestras redes sociales!</h1>
    <div>
      <a target="_blank" href="https://www.instagram.com/mendozafutura.comunidad/"><i class="rosado fa-brands fa-square-instagram"></i></a>
  ...
  <a title="Educar LAB" href="#top">
    <img class="header-logo" src="./logosConectar/logoMendozaFutura2.png"  alt="logoMendozaFutura" >
  </a>
`;
};
